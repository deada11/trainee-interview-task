...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> getAllProducts(
            ...
            @RequestParam(required = false) BigDecimal lessThanPrice,
            @RequestParam(required = false) BigDecimal greaterThanPrice,
            @RequestParam(required = false) Boolean availability,
            @RequestParam(required = false) String sortBy,
            @RequestParam(required = false) Integer limit) {
        return ResponseEntity.ok().body(productRestServiceImpl.readAllProducts(name, lessThanPrice, greaterThanPrice, availability, sortBy, limit));
    }
