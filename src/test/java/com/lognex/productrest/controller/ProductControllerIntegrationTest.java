...
class ProductControllerIntegrationTest {
    ...
    protected final static UUID TEST_PRODUCT_ID = UUID.fromString("a935b53c-61b9-45d0-be81-27b10f1dca6e");
    private final static UUID TEST_NON_EXISTENT_PRODUCT_ID = UUID.fromString("1040f406-97b8-490b-bd25-7168abcacfa0");
    protected final static UUID TEST_NEW_PRODUCT_ID = UUID.fromString("31dedd55-6175-46ed-ad09-cbcbce65d7a8");
    protected final static String TEST_CORRECT_NAME = "test product";
    protected final static String TEST_NEW_CORRECT_NAME = "updated test product";
    protected final static String TEST_CORRECT_DESCRIPTION = "test description";
    protected final static String TEST_NEW_CORRECT_DESCRIPTION = "updated test description";
    protected final static BigDecimal TEST_CORRECT_PRICE = BigDecimal.valueOf(1234.56);
    protected final static BigDecimal TEST_NEW_CORRECT_PRICE = BigDecimal.valueOf(6543.21);
